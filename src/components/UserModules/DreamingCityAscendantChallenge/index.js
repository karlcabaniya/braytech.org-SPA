...
export default function DreamingCityAscendantChallenge({ cycleInfo }) {
  const definitions = [4, 6, 8, 10, 12, 14];
  const definitionNode = manifest.BraytechMapsDefinition[definitions[cycleInfo.week.ascendant - 1]];
