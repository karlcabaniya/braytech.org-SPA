...
export default function Menagerie({ cycleInfo }) {
  ...
  const rotation = {
    1: {
      boss: t('UserModules.Menagerie.Hasapiko.Name'),
    ...
    2: {
      boss: t('UserModules.Menagerie.Arunak.Name'),
    ...
    3: {
      boss: t('UserModules.Menagerie.Pagouri.Name'),
  ...
  return (
    <>
      ...
      <div className='text'>
        <p>
          <em>{manifest.DestinyPlaceDefinition[2096719558]?.displayProperties?.description}</em>
        </p>
      </div>
      {heroicMenagerie ? (
        <>
