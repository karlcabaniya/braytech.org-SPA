      ...
      <div className='user'>
        <div className='summary'>
          ...
          <div className='basics'>
            ...
            <div>
              <div className='value'>{member.data.profile.profileRecords.data.score.toLocaleString(this.props.i18n.language)}</div>
              <div className='name'>{t('Triumph score')}</div>
            </div>
            <div>
              <div className='value'>{utils.collectionTotal(member.data.profile).toLocaleString(this.props.i18n.language)}</div>
